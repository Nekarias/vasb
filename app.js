//@Quelle: https://joelvardy.com/writing/javascript-image-upload/
	...
	document.querySelector('form input[type=file]').addEventListener('change', function (event) {
		...
		for (var i in files) {
			...
			(function () {
				...
				resize.photo(files[i], 320, 'file', function (resizedFile) {
					...
					resize.photo(resizedFile, 320, 'dataURL', function (thumbnail) {
